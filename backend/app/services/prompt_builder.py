...
Для enumitem подключайте только как \usepackage{enumitem}; не передавайте package option list=true и не используйте \usepackage[list=true]{enumitem}, потому что это невалидная опция enumitem в pdfLaTeX.
